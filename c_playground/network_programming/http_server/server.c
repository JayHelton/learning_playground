/**
 * Pretty ugly impl of a webserver
 */
...
int main() {
    ...
    while(1) {
        ...
        if (FD_ISSET(server, &reads)) {
            /**
             * Gets or creates a client that is connection
             */
        ...
        /**
         * clients are a link list
         * keep enumerating and checking if they are set.
         *
         * in a legit async runtime, we would have a task impl with a timer or something
         * not just polling these sockets
         */
