/**
 * This one is mostly copy pasta, but gives a good idea of what happens 
 * when we need to manually query DNS.
 *
 * You have to encode the data in specific ways and intepret them.
 */
